...
class Gate5QualificationTests(unittest.TestCase):
    ...
    def test_performance_terminal_status_is_not_promoted_by_completed_process(self):
        self.assertEqual(qa_gate5_field_quality.performance_terminal_status({"status": "PAIRED", "comparison_status": "PASS"}), "PASS")
        self.assertEqual(qa_gate5_field_quality.performance_terminal_status({"status": "PAIRED", "comparison_status": "VERIFY_REQUIRED"}), "VERIFY_REQUIRED")
        for payload in (None, {}, {"status": "PAIRED"}, {"status": "PAIRED", "comparison_status": "FIX_REQUIRED"}, {"status": "PAIRED", "comparison_status": "UNVERIFIED"}):
