...
from qa_map_visual_integrity import integrity_result, make_corruption_fixture, measure  # noqa: E402


class MapVisualIntegrityTests(unittest.TestCase):
    def setUp(self):
        # Keep the detector unit test independent of historical/generated QA
        # captures. Fresh candidate-bound screenshots are tested by the R11
        # evidence harness, while this test exercises only detector behavior.
        self.clean = Image.new("RGB", (1044, 712), (220, 220, 220))
