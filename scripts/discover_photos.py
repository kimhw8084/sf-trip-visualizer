...
QUERIES = {
    ...
    "aquatic_park": 'intitle:"Aquatic Park" San Francisco',
    "alamo_square": 'intitle:"Alamo Square" San Francisco',
    "outpost": 'intitle:"Outpost Playground" Presidio San Francisco',
    "carmel_beach": 'intitle:"Carmel Beach" California',
    "gabrielson_park": 'intitle:"Gabrielson Park" Sausalito',
    "cantor_arts": 'intitle:"Cantor Arts Center" Stanford',
    "rodin_garden": 'intitle:"Rodin Sculpture Garden" Stanford',
    "stanford_quad": 'intitle:"Stanford Main Quad" California',
    "sentinel_beach": 'intitle:"Sentinel Beach" Yosemite',
    "baker_beach": 'intitle:"Baker Beach" San Francisco Presidio',
}
EXTRA_QUERIES = {
    "outpost": ["Presidio Tunnel Tops Outpost Playground", "Presidio Outpost Playground San Francisco", "Tunnel Tops playground San Francisco"],
    "stanford_quad": ["Stanford Main Quad California", "Stanford Memorial Court Quad", "Stanford Oval Main Quad"],
    "sentinel_beach": ["Sentinel Beach picnic area Yosemite", "Sentinel Beach Yosemite National Park Merced River", "Sentinel Beach Yosemite Valley"],
    "gabrielson_park": ["Gabrielson Park Sausalito waterfront", "Gabrielson Park Sausalito California", "Sausalito Gabrielson waterfront park"],
