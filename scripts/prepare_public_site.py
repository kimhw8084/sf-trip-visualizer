...
QUALIFICATION = ROOT / "QA" / "CHG-232" / "release" / "qualification.json"
PROVENANCE = ".release-provenance.json"
RIGHTS_REPORT = ROOT / "QA" / "CHG-232" / "release" / "public_asset_rights.json"
...
def main() -> None:
    ...
    if not QUALIFICATION.is_file():
        raise SystemExit("No QA/CHG-232/release/qualification.json; public assembly is gated on full qualification.")
