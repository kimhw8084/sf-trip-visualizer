...
expected_routes = sorted(json.loads((ROOT / "data/phase7_app_data.json").read_text())["routes"])
expected_places = len(json.loads((ROOT / "data/phase7_app_data.json").read_text())["markers"])
