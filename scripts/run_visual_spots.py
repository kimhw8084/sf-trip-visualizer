...
with sync_playwright() as playwright:
    ...
    for width, height in ((1440, 900), (390, 844)):
        ...
        for route in ("A1", "A2", "B1", "B2"):
            ...
            shot = SHOTS / f"final_visual_{width}_{route}_sf.png"
        ...
        if width == 390:
            ...
            shot = SHOTS / "final_visual_390_route_guide.png"
            page.screenshot(path=str(shot))
...
(ROOT / "QA/visual_spots.json").write_text(json.dumps(report, ensure_ascii=False, indent=2) + "\n")
