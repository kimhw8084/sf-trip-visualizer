...
with sync_playwright() as playwright:
    ...
    for route, date in (("A1", "10/3"), ("A2", "10/4"), ("B1", "10/7"), ("B2", "10/10")):
        row = page.evaluate(
    ...
    page.evaluate("async()=>{const a=window.__tripApp;a.state.routes=new Set(['A1']);a.state.date='all';a.state.region='overall';a.setMode('decide');await a.drawMap(false)}")
