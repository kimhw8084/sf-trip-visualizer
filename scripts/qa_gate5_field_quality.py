...
EVIDENCE_ROOT = ROOT / "QA" / "CHG-232" / "gate5"
...
CURRENT_EVIDENCE = {
    ...
    "provider_recovery": ROOT / "QA" / "CHG-232" / "release" / "gate4_runtime.json",
}
...
def write_auxiliary(report: dict, performance: dict) -> None:
    ...
    REVIEW_INDEX.write_text(json.dumps({"schema_version": 1, "candidate_revision": report["candidate_head"], "source": "CHG-232 current single-route qualification", "screenshots": screenshot_paths}, ensure_ascii=False, indent=2) + "\n")
